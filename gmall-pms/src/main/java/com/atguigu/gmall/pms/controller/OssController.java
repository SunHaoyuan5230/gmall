...
public class OssController {
    ...
    public Resp<Object> policy() {
        String accessId = "LTAI4Fw9823YfuReUpRNBCRn"; // 请填写您的AccessKeyId。
        String accessKey = "xDm8R0sHJKsFHhqLIVZCScEepPByhX"; // 请填写您的AccessKeySecret。
        String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
        String bucket = "gmall-shy"; // 请填写您的 bucketname 。
